        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              _filterChip('Communication', 'sector', 'Communication Services'),
              _filterChip('Consumer Disc.', 'sector', 'Consumer Discretionary'),
              _filterChip('Consumer Staples', 'sector', 'Consumer Staples'),
              _filterChip('Energy', 'sector', 'Energy'),
              _filterChip('Financials', 'sector', 'Financials'),
              _filterChip('Health Care', 'sector', 'Health Care'),
              _filterChip('Industrials', 'sector', 'Industrials'),
              _filterChip('Technology', 'sector', 'Information Technology'),
              _filterChip('Materials', 'sector', 'Materials'),
              _filterChip('Real Estate', 'sector', 'Real Estate'),
              _filterChip('Utilities', 'sector', 'Utilities'),
            ],
          ),
