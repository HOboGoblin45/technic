            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    Colors.white.withOpacity(_isPressed ? 0.08 : 0.06),
                    Colors.white.withOpacity(_isPressed ? 0.04 : 0.02),
                  ],
                ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Icon(icon, size: 14, color: buttonColor.withOpacity(0.8)),
            const SizedBox(width: 6),
            Text(
              label,
              style: TextStyle(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            gainColor.withOpacity(0.12),
            gainColor.withOpacity(0.04),
          ],
        ),
