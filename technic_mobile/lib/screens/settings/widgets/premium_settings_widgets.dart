        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                Colors.white.withOpacity(_isPressed ? 0.1 : 0.06),
                Colors.white.withOpacity(_isPressed ? 0.05 : 0.02),
              ],
            ),
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [
                color.withOpacity(widget.isDanger ? 0.15 : 0.08),
                color.withOpacity(widget.isDanger ? 0.08 : 0.04),
              ],
            ),
            borderRadius: BorderRadius.circular(14),
            border: Border.all(
              color: color.withOpacity(widget.isDanger ? 0.3 : 0.15),
            ),
          ),
          child: Row(
      ...
      builder: (context, child) {
        return Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [
                (widget.isActive ? color : Colors.white).withOpacity(0.15),
                (widget.isActive ? color : Colors.white).withOpacity(0.08),
              ],
            ),
            borderRadius: BorderRadius.circular(20),
            border: Border.all(
              color: (widget.isActive ? color : Colors.white).withOpacity(0.3),
            ),
          ),
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              Transform.scale(
                ...
                child: Container(
                  ...
                  height: 8,
                  decoration: BoxDecoration(
                    color: widget.isActive ? color : Colors.white.withOpacity(0.4),
                    shape: BoxShape.circle,
              ...
              Text(
                widget.label,
                style: TextStyle(
                  color: widget.isActive ? color : Colors.white.withOpacity(0.6),
                  fontSize: 12,
                  fontWeight: FontWeight.w600,
                ),
              ),
