        ...
        return Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                Colors.white.withValues(alpha: 0.08 + 0.04 * _searchAnimation.value),
                Colors.white.withValues(alpha: 0.04 + 0.02 * _searchAnimation.value),
              ],
            ),
            borderRadius: BorderRadius.circular(12),
            border: Border.all(
              color: Colors.white.withValues(alpha: 0.1 + 0.1 * _searchAnimation.value),
              width: 1,
            ),
          ),
          child: ClipRRect(
