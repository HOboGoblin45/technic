...
class _PremiumLineChartState extends State<PremiumLineChart>
  ...
  Widget build(BuildContext context) {
    ...
    final fillColor = widget.fillColor ?? lineColor.withOpacity(0.2);
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      final color = candle.isUp
          ? AppColors.successGreen.withOpacity(isSelected ? 0.8 : 0.4)
          : AppColors.dangerRed.withOpacity(isSelected ? 0.8 : 0.4);
