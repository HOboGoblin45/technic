...
class PremiumDateRangePicker extends StatelessWidget {
  ...
  static final List<DatePreset> defaultPresets = [
    DatePreset('Today', () => DateTimeRange(
      start: DateTime.now(),
      end: DateTime.now(),
    )),
    DatePreset('Last 7 Days', () => DateTimeRange(
      start: DateTime.now().subtract(const Duration(days: 7)),
      end: DateTime.now(),
    )),
    DatePreset('Last 30 Days', () => DateTimeRange(
      start: DateTime.now().subtract(const Duration(days: 30)),
      end: DateTime.now(),
    )),
    DatePreset('Last 90 Days', () => DateTimeRange(
      start: DateTime.now().subtract(const Duration(days: 90)),
      end: DateTime.now(),
    )),
    DatePreset('This Year', () => DateTimeRange(
...
class DatePreset {
  ...
  const DatePreset(this.label, this.getRange);
}
