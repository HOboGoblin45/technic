            ...
            return Expanded(
              ...
              child: Text(
                ...
                style: TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.w600,
                  color: highlight ?? Colors.white.withValues(alpha: 0.9),
                ),
              ),
            );
          }),
                ...
                children: [
                  ...
                  if (entry.badge != null)
                    Container(
                      ...
                      padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                      decoration: BoxDecoration(
                        color: (entry.badgeColor ?? AppColors.primaryBlue).withValues(alpha: 0.15),
                        borderRadius: BorderRadius.circular(4),
                      ),
                      child: Text(
                        entry.badge!,
      ...
      children: [
        if (stat.icon != null) ...[
          Icon(
            stat.icon,
            size: 14,
            color: stat.color ?? Colors.white.withValues(alpha: 0.5),
          ),
