          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  Colors.white.withOpacity(widget.notification.isRead ? 0.04 : 0.08),
                  Colors.white.withOpacity(widget.notification.isRead ? 0.02 : 0.04),
                ],
              ),
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            color: Colors.white.withOpacity(widget.notification.isRead ? 0.5 : 0.7),
            fontSize: 13,
            height: 1.4,
          ),
          maxLines: 2,
...
class _PremiumPriceAlertCardState extends State<PremiumPriceAlertCard>
  ...
  Color get _statusColor {
    ...
    if (!widget.isActive) return Colors.white.withOpacity(0.3);
    return AppColors.warningOrange;
  }
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                Colors.white.withOpacity(widget.isActive ? 0.08 : 0.04),
                Colors.white.withOpacity(widget.isActive ? 0.04 : 0.02),
              ],
            ),
            borderRadius: BorderRadius.circular(16),
            border: Border.all(
